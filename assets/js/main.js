...
const moodTracks = {
  happy: [
    "assets/audio/happy1.flac",
    "assets/audio/happy2.mp3",
    "assets/audio/happy3.flac",
  ],
  sad: [
  ...
  exciting: [
    "assets/audio/exciting.mp3",
    "assets/audio/exciting2.mp3",
    "assets/audio/exciting3.mp3",
  ],
  scared: [
    "assets/audio/scared.mp3",
    "assets/audio/scared2.mp3",
    "assets/audio/scared3.flac",
  ],
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  submitButton.addEventListener("click", function () {
    ...
    moodQuote.textContent =
      moodQuotes[mood][Math.floor(Math.random() * moodQuotes[mood].length)];
